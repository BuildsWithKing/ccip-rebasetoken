...
contract CrossChainTest is Test {
    ...
    function configureTokenPool(
        ...
        // This ensures we are working on the right chain.
        vm.selectFork(fork);
        vm.prank(owner);
    ...
    function bridgeTokens(
        ...
        assertLt(localBalanceAfter, localBalanceBefore);
    ...
    function testBridgeAllTokens() public {
        ...
        vm.deal(user, AMOUNT);
        vm.prank(user);
        Vault(payable(address(vault))).deposit{value: AMOUNT}();
        assertEq(sepoliaToken.balanceOf(user), AMOUNT);
        bridgeTokens(
            AMOUNT,
            sepoliaFork,
            arbSepoliaFork,
